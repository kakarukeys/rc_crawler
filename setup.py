...
#
#     from rc_crawler import metadata
#
# However, when we do this, we also import `rc_crawler/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'rc_crawler_cli = rc_crawler.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'rc_crawler_gui = rc_crawler.gui:entry_point'
        # ]
    }
)
